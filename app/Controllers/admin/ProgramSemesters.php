...
class ProgramSemesters extends BaseController
{
    ...
    {
        $data = [
            'title' => 'Program Semester Assignments',
            'page' => 'admin'
        ];
        $content = view('admin/program_semesters/index', $data);
    ...
    public function create()
    {
        ...
        if (empty($data['program_id']) || empty($data['name']) || empty($data['code'])) {
            return $this->response->setJSON([
                'success' => false,
                'message' => 'Program, Semester Name, and Code are required fields.',
        ...
        try {
            ...
            return $this->response->setJSON([
                'success' => true,
                'message' => 'Semester assigned to program successfully',
                'id' => $insertId,
