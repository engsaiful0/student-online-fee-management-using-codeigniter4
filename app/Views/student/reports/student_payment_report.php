<div class="content-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0"><i class="bi bi-receipt"></i> My Payment Report</h4>
        <div class="btn-group" role="group">
            <a href="<?= base_url('student/reports/student-payment-report/pdf') ?>" class="btn btn-danger">
                <i class="bi bi-file-pdf"></i> Export PDF
            </a>
            <a href="<?= base_url('student/reports/student-payment-report/excel') ?>" class="btn btn-success">
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <?php if (empty($fees)): ?>
                    <tr>
                        <td colspan="10" class="text-center text-muted">No payment data found</td>
                    </tr>
                <?php else: ?>
